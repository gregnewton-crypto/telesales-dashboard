 ...
 *
 * AUTOMATION SETUP
 *   Trigger: When record updated in tbllpLbEtTkmMQOY9
 *   Watch:   fldsKBO1ZpAImfV8C  Times Lead has been Called (rollup)
 ...
 *
 * Each run writes (force sync):
 *   rollup/lookup → Kanban single selects
...
const CLOSED_STATUSES = new Set(['success', 'not interested', 'invalid']);
const OPEN_STATUSES = new Set(['automatic redial', 'vip callback', 'private callback']);
