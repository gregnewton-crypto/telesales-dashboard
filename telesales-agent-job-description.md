...
- Build rapport quickly, ask the right questions, and recommend the right plan for each dog.
- Confidently handle questions and objections, and guide interested owners to their first box.
- Keep your pipeline, notes and call outcomes accurate and up to date in our CRM.
- Hit (and beat!) your conversion and sales targets.
- Listen back to calls with your team lead, take on feedback, and apply it straight away.
- Help our telesales channel grow and perform better and better — your ideas count.

## ☀️ A day in the life of a Butternut Box Telesales Agent

You log in, put on your headset, and your leads are ready: owners who have personally expressed interest in Butternut Box. After a quick check-in with your team lead, you get to work.

Your first conversation is with the owner of a dog that reacts poorly to dry food. You ask the right questions, build trust and give tailored advice. You hit it off, and they start with their first box. You can already tell this customer is a perfect fit — and that it won't stop at one box.

Halfway through your shift, you listen back to a call with your team lead. You get targeted feedback and apply it immediately, and your conversations run even more smoothly afterwards.

At the end of your shift, you can see exactly what you've achieved: four new clients and four dogs that will truly benefit from Butternut Box. At the end of the month, you'll see it on your payslip too — including commission for every new customer. Kaching. 🐾

## 👀 What we're looking for

- You communicate clearly and confidently, and build rapport with people easily.
- Targets motivate you, and you enjoy working in a results-oriented way.
- You're coachable — you welcome feedback and act on it immediately.
...
- 25 days holiday (plus bank holidays) and an additional day for every year of service up to 5 years.
- 5 additional, paid 'paws' days off per year dedicated to your learning, development or personal wellbeing.
- £250 personal learning & development budget to sharpen your skills.
- A significant discount on our Fresh food, to keep your own dogs as healthy as our customers'.
- Enhanced parental leave, plus paid time off for fertility treatments and pregnancy loss.
- Paid sabbaticals for squad members with 5 or more years' service at Butternut.
- Pension with NEST, Private Medical Insurance with Vitality and Private Dental Insurance with Bupa.
- Cycle to work scheme and discounted gym access through MyGymDiscounts.
- A friendly, close-knit team with a fun outing every few weeks.
- Lots of office dogs (Ajax, Peggy, Chief, Louis, Hansen, Winnie and many more…).
- Working at a certified B Corp with a positive impact.

## ⏳ The interview process

- Initial call with your dedicated Talent Acquisition Partner, carried out remotely.
- Sometimes the process will include a short sales pitch or role-play so we can hear you in action.
- Final interview, where you'll also meet some of your potential future colleagues.

We usually expect our interview process to take 1–3 weeks, end to end. This vacancy has no fixed start date — if there's a match, you can start quickly.
...
Are you the perfect candidate for this vacancy? Then click **'Apply now!'** and we'll be in touch as soon as possible.
